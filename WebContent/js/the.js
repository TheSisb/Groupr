...
$(function(){
	...
	function browseAllGroups( page ){
		browseTable('/groupsoen3872011k/servlet/BrowseGroups?page=1', "#GroupViewFiller", "pageOfGroups", "BrowseGroups?page=", page);
	}
	...
	function browseAllInvites( page ){
		browseTable('/groupsoen3872011k/servlet/BrowseInvites?page=1', "#InviteViewFiller", "pageOfInvites", "BrowseInvites?page=", page);	
	}
	...
	function browseAllMembers( page ){
		browseTable('/groupsoen3872011k/servlet/ViewGroup?page=1', "#memberListFiller", "pageOfMembers", "ViewGroup?page=", page);
	}
	...
	function browseAllRequests( page ){
		browseTable('/groupsoen3872011k/servlet/BrowseRequests?page=1', "#groupRequestFiller", "pageOfRequests", "BrowseRequests?page=", page);
	}
	...
	function insertTableFromJson(json, oldID, newID, paginationURL){
		...
		if(size === undefined || size <= 0){
			...
			for (var i=1; i<=pages; i++){
				pagination.push("<a class='page' href='/groupsoen3872011k/servlet/" + paginationURL + i +"'>" + i + "</a>");
			}
			pagination.push("</div>");
	...
	$('.kick').live("click", function(e){
		...
		$.get(req, function(data){
			...
			location.href = "/groupsoen3872011k/servlet/home";
		});
	});
