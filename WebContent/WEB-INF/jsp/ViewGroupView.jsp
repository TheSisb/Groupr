...
"Kick":"<a class='kick' href='/groupsoen3872011k/servlet/RemoveMember?memberID=${memberProfile.id}'><img src='/groupsoen3872011k/servlet/img/boot.png' width=30 height=30 alt='Kick this user' /></a>"
}</c:when><c:otherwise>
,{
