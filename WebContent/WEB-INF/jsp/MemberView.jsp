...
<body>
	<div id='overlay'>
		<div id='overlayBox'>
			...
			<div id='sendInvite'>
				...
				<form method='POST' action='/groupsoen3872011k/servlet/InviteMember'>
					<p>
			...
			<div id='editGroupInfo'>
				<h3>Edit Group</h3>
				<form method='POST' action='/groupsoen3872011k/servlet/EditGroup'>
					<p>
	...
	<div id='container'>
		<header>
			...
			<h1><a href='/groupsoen3872011k/servlet/home'>Groupr</a></h1>	
		</header>	
