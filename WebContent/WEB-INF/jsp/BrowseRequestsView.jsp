...
,{
"User":"${aUser.username}",
"Accept":"<a href='/groupsoen3872011k/servlet/AcceptEntry?requesterID=${aUser.id}'><img width=30 height=30 src='/groupsoen3872011k/servlet/img/accept.png'/></a>",
"Deny":"<a href='/groupsoen3872011k/servlet/CancelEntry?requesterID=${aUser.id}'><img width=30 height=30 src='/groupsoen3872011k/servlet/img/deny.png'/></a>"
}</c:when><c:otherwise>
,{
"User":"${aUser.username}",
"Accept":"<a href='/groupsoen3872011k/servlet/AcceptEntry?requesterID=${aUser.id}'><img width=30 height=30 src='/groupsoen3872011k/servlet/img/accept.png'/></a>",
