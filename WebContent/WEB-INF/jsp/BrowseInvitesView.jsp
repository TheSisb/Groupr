...
"accept":"<a href='/groupsoen3872011k/servlet/AcceptInvites?groupID=${invite.group.id}'><img width=30 height=30 src='/groupsoen3872011k/servlet/img/accept.png'/></a>",
"deny":"<a href='/groupsoen3872011k/servlet/DeclineInvites?inviteID=${invite.id}'><img width=30 height=30 src='/groupsoen3872011k/servlet/img/deny.png'/></a>"
}</c:when><c:otherwise>
,{
"inviter":"${invite.inviter.username}",
"groupname":"${invite.group.name}",
